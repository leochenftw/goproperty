    ...
    <div class="container has-text-centered">
        ...
        <div class="search-forms hide is-paddingless">
            <% with $PropertySearchForm %>
                <form $FormAttributes>
                    <div id="form-description" class="form-description columns vertical-centered">
                        <div class="column has-text-left"><h2 class="title is-2 is-bold">Refining your search result</h2></div>
