                ...
                <div class="column" style="border-right: 1px solid #ccc;">
                    ...
                    <div class="columns is-marginless">
                        <div class="column content">
                            <p class="title is-4">As a special introductory offer we are offering a free sign up for the first 28 days.</p>
                            <p>During this time, you can apply for a rental property, you could offer a property for rental or sale or set up your Tradesperson account to help advertise your business.</p>
                        </div>
                    </div>
                </div>
            <% end_if %>
