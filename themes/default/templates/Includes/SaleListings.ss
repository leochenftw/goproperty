<div class="ajax-content">
    <div class="columns is-marginless vertical-bottom">
        <div class="column is-paddingless"><h4 class="title">Sale listings</h4></div>
        <div class="column is-paddingless is-auto-width has-text-right"><a class="btn-listing button outlined inline" href="/member/action/sale-listing?id=$Property.ID">New...</a></div>
    </div>
    <div class="all-listings">
    <% if $Property.SaleListings.Count > 0 %>
        <% loop $Property.SaleListings %>
        <div class="columns">
            <%-- <div class="column">
            ...
            <div class="column is-auto-width actions">
                ...
                <h4 class="title is-5">
                    <a class="btn-listing button inline" href="/member/action/sale-listing?id=$Up.ID&listing-id=$ID">Edit</a>
