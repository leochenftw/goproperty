        ...
        <div class="fields__main">
            <div class="fields__main__section property">
                ...
                <div class="fields__main__section__content">
                    <% loop $Fields %>
                        <% if $Name != 'FullAddress' && $Name != 'Gallery' && $Name != 'ContactNumber' && $Name != 'ListerAgencyID' && $Name != 'AgencyReference' && $Name != 'RateableValue' && $Name != 'HideRV' && $Name != 'PriceOption' && $Name != 'AskingPrice' && $Name != 'EnquiriesOver' && $Name != 'AuctionOn' && $Name != 'TenderCloseOn' && $Name != 'PriceByNegotiation' && $Name != 'PrivateTreatyDeadline'  %>
                            $FieldHolder
                        <% end_if %>
                    <% end_loop %>
